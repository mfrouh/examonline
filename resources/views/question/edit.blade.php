          ...
          <div class="card-body">
             <form action="/question/{{$question->id}}" method="post">
                ...
                <div class="form-group">
                  ...
                  <textarea name="question" id="" class="form-control  @error('question') is-invalid @enderror">{{$question->question}}</textarea>
                   @error('question')
                ...
                <div class="form-group">
                    ...
                    <select name="type" id="changetype" class="form-control  @error('type') is-invalid @enderror" value="{{old('type')}}">
                        ...
                        <option value="choiceone" {{$question->type=='choiceone'?'selected':''}}>@lang('home.choiceone')</option>
                        <option value="trueorfalse" {{$question->type=='trueorfalse'?'selected':''}}>@lang('home.trueorfalse')</option>
                        <option value="complete"{{$question->type=='complete'?'selected':''}}>@lang('home.complete')</option>
                        <option value="multiplechoice" {{$question->type=='multiplechoice'?'selected':''}}>@lang('home.multiplechoice')</option>
                    </select>
                     @error('type')
                       <span class="invalid-feedback" role="alert">
                           <strong>{{ $message }}</strong>
                ...
                <div class="form-group" id="option1" @error("option1") {{''}} @else {{'hidden'}} @enderror>
                    ...
                    <input type="text" name="option1"  class="form-control  @error("option1") is-invalid @enderror" value="{{$question->option1}}">
                     @error("option1")
                       <span class="invalid-feedback" role="alert">
                           <strong>{{ $message }}</strong>
                       </span>
                    ...
                    <input type="text" name="option2"  class="form-control  @error("option2") is-invalid @enderror" value="{{$question->option2}}">
                     @error("option2")
                       <span class="invalid-feedback" role="alert">
                           <strong>{{ $message }}</strong>
                       </span>
                    ...
                    <input type="text" name="option3"  class="form-control  @error("option3") is-invalid @enderror" value="{{$question->option3}}">
                     @error("option3")
                       <span class="invalid-feedback" role="alert">
                           <strong>{{ $message }}</strong>
                       </span>
                ...
                <div class="form-group" id="option4" @error("option4") {{''}} @else {{'hidden'}} @enderror>
                    ...
                    <input type="text" name="option4"  class="form-control  @error("option4") is-invalid @enderror" value="{{$question->option4}}">
                     @error("option4")
                       <span class="invalid-feedback" role="alert">
                           <strong>{{ $message }}</strong>
                       </span>
                ...
                <div class="form-group" id="correctanswer" @error("correctanswer") {{''}} @else {{'hidden'}} @enderror value="{{$question->correctanswer}}">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="mark"  class="form-control  @error('mark') is-invalid @enderror" value="{{$question->mark}}">
                     @error('mark')
                       <span class="invalid-feedback" role="alert">
                           <strong>{{ $message }}</strong>
                       </span>
